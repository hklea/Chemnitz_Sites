...
//   return (
//     <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
//       <div className="min-h-screen w-full bg-gradient-to-br from-blue-500 via-gray-200 to-white flex items-center justify-center relative overflow-hidden">
//         <div className="absolute inset-0 backdrop-blur-2xl bg-white/10 z-0"></div>
//         <div className="z-10 w-full max-w-md p-8 bg-white bg-opacity-70 rounded-2xl shadow-2xl backdrop-blur-lg">
//           {isRegister ? (
...
function AuthPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-200 via-blue-100 to-white p-4">
      <div className="z-10 w-full max-w-md p-8 bg-white bg-opacity-90 rounded-2xl shadow-xl">
        {isRegister ? (
          <RegisterForm setIsRegister={setIsRegister} />
        ) : (
          <LoginForm setIsRegister={setIsRegister} />
