...
// import img9 from '../assets/homeimg/chemnitz4.jpeg';
...
//           <h1 className="text-4xl sm:text-6xl font-bold mb-4">IT'S TIME TO</h1>
//           <h2 className="text-5xl sm:text-7xl font-extrabold mb-6">VISIT CHEMNITZ!</h2>
...
const Home: React.FC = () => {
  ...
  return (
    <>
      {/* Full-screen Carousel */}
      <div className="relative w-screen h-[calc(100vh-100px)] min-h-[500px] overflow-hidden">
        {images.map((img, index) => (
          <img
            key={index}
            src={img}
